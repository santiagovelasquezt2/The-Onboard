...
} from './components/DrivingLineLabPanel'
...
import { readStoredRacingLineAnchors } from './racingLineCalibration'
import { readStoredReplaySyncAnchors } from './replaySyncCalibration'
import {
...
export default function DrivingLineLab() {
  ...
  const [racingLineAnchors] = useState(() =>
    readStoredRacingLineAnchors(
      DEFAULT_RACING_LINE_ANCHORS,
      DEFAULT_REPLAY_DURATION_SECONDS,
    ),
  )
  const [replaySyncAnchors] = useState(() =>
    readStoredReplaySyncAnchors(DEFAULT_REPLAY_DURATION_SECONDS),
  )
