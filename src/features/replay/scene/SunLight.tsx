...
import { resizeDirectionalShadowMap } from './replayQuality'
...
export const SunLight = forwardRef<THREE.Group, SunLightProps>(
  function SunLight({ shadowMapSize = SHADOW_MAP_SIZE }, ref) {
    ...
    useLayoutEffect(() => {
      ...
      if (!light) return
      light.target = target
      resizeDirectionalShadowMap(light.shadow, shadowMapSize)
