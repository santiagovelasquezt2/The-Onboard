...
/**
 * Onboard T-cam mount in car-local metres (W14 GLB: nose = +Z, road = +Y≈0).
 * Mesh `camera_wing001_29` ≈ (0, 1.13, -0.05). Negative BACK = lens forward of
 * the airbox origin. Chosen by landmark NDC scoring vs PiP (halo lower-third,
 * wheel low, tires outboard). OpenF1 has no camera pose.
 * Live tune: `?tcam=back,height,lookH,lookF,fov`
 */
export const ONBOARD_CAMERA_BACK = -0.15
export const ONBOARD_CAMERA_HEIGHT = 1.4
/** FOM T-cam sits slightly left of centerline on the airbox. */
...
export const SKY_TURBIDITY = 4
export const SKY_RAYLEIGH = 2.2
export const SKY_MIE_COEFFICIENT = 0.0035
export const SKY_MIE_DIRECTIONAL_G = 0.75

/** Matches the sky's horizon so the 5 km skyline blockout doesn't read flat. */
export const FOG_COLOR = '#b6c9dc'
