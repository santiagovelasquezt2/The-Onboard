...
sequenceDiagram
  ...
  participant L as Lab controller<br/>DrivingLineLab.tsx
...
[`src/DrivingLineLab.tsx`](../../src/DrivingLineLab.tsx)
Repo: Openf1-garage
...
[`src/components/OnboardVideo.tsx`](../../src/components/OnboardVideo.tsx)
Repo: Openf1-garage
...
[`src/drivingLineLabClock.ts`](../../src/drivingLineLabClock.ts)
Repo: Openf1-garage
...
[`src/components/DrivingLineLabPanel.tsx`](../../src/components/DrivingLineLabPanel.tsx)
Repo: Openf1-garage
...
[`src/drivingLineLab.ts`](../../src/drivingLineLab.ts)
Repo: Openf1-garage
...
[`src/proposedDrivingLine.ts`](../../src/proposedDrivingLine.ts), [`src/proposedDrivingLineVariant2.ts`](../../src/proposedDrivingLineVariant2.ts), and [`src/proposedDrivingLinePass.ts`](../../src/proposedDrivingLinePass.ts)
Repo: Openf1-garage
...
[`src/components/scene/DrivingLinePreview.tsx`](../../src/components/scene/DrivingLinePreview.tsx)
Repo: Openf1-garage
